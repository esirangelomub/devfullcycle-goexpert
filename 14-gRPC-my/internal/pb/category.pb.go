...
var file_category_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x4d, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61, 0x74, 0x65,
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xd3, 0x02, 0x0a, 0x0f, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
...
var file_category_proto_depIdxs = []int32{
	3, // 0: pb.CategoryList.categories:type_name -> pb.Category
	0, // 1: pb.CategoryService.CreateCategory:input_type -> pb.CreateCategoryRequest
	0, // 2: pb.CategoryService.CreateCategoryStream:input_type -> pb.CreateCategoryRequest
	0, // 3: pb.CategoryService.CreateCategoryStreamBidirectional:input_type -> pb.CreateCategoryRequest
	...
	3, // 6: pb.CategoryService.CreateCategory:output_type -> pb.Category
	1, // 7: pb.CategoryService.CreateCategoryStream:output_type -> pb.CategoryList
	3, // 8: pb.CategoryService.CreateCategoryStreamBidirectional:output_type -> pb.Category
	1, // 9: pb.CategoryService.ListCategories:output_type -> pb.CategoryList
	3, // 10: pb.CategoryService.GetCategory:output_type -> pb.Category
