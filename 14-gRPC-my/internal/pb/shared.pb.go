...
type Category struct {
	...
	Courses     []*Course `protobuf:"bytes,4,rep,name=courses,proto3" json:"courses,omitempty"` // hasMany relationship with Courses
}
...
type Course struct {
	...
	Name        string    `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Description string    `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	Category    *Category `protobuf:"bytes,4,opt,name=category,proto3" json:"category,omitempty"`                       // belongsTo relationship with Category
	Lessons     []*Lesson `protobuf:"bytes,5,rep,name=lessons,proto3" json:"lessons,omitempty"`                         // hasMany relationship with Lessons
	CategoryId  string    `protobuf:"bytes,6,opt,name=category_id,json=categoryId,proto3" json:"category_id,omitempty"` // The raw ID of the category, which can be useful in some contexts
}
...
type Lesson struct {
	...
	Course      *Course `protobuf:"bytes,5,opt,name=course,proto3" json:"course,omitempty"`                     // belongsTo relationship with Course
	CourseId    string  `protobuf:"bytes,6,opt,name=course_id,json=courseId,proto3" json:"course_id,omitempty"` // The raw ID of the category, which can be useful in some contexts
}
...
func (x *Lesson) GetCourse() *Course {
	if x != nil {
		return x.Course
	}
	return nil
...
var file_shared_proto_rawDesc = []byte{
	...
	0x70, 0x62, 0x22, 0x07, 0x0a, 0x05, 0x42, 0x6c, 0x61, 0x6e, 0x6b, 0x22, 0x76, 0x0a, 0x08, 0x43,
	...
	0x07, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a,
	0x2e, 0x70, 0x62, 0x2e, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x72,
	0x73, 0x65, 0x73, 0x22, 0xbf, 0x01, 0x0a, 0x06, 0x43, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x12, 0x0e,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x52, 0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x24,
	0x0a, 0x07, 0x6c, 0x65, 0x73, 0x73, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x0a, 0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x65, 0x73, 0x73, 0x6f, 0x6e, 0x52, 0x07, 0x6c, 0x65, 0x73,
	0x73, 0x6f, 0x6e, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79,
	0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x49, 0x64, 0x22, 0xa9, 0x01, 0x0a, 0x06, 0x4c, 0x65, 0x73, 0x73, 0x6f, 0x6e,
	...
	0x12, 0x22, 0x0a, 0x06, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	...
	0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x75, 0x72, 0x73, 0x65, 0x49,
	0x64, 0x42, 0x0d, 0x5a, 0x0b, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x62,
...
var file_shared_proto_depIdxs = []int32{
	2, // 0: pb.Category.courses:type_name -> pb.Course
	1, // 1: pb.Course.category:type_name -> pb.Category
	3, // 2: pb.Course.lessons:type_name -> pb.Lesson
	2, // 3: pb.Lesson.course:type_name -> pb.Course
